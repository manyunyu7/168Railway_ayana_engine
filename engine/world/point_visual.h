...
// (30 x 12) and a vertical curtain (30 x 7) 12 m along the leg, in the leg's colour.
#pragma once
...
public:
  ...
  // Uses the eye given to ModelRenderer::beginFrame for the padlock billboard and glow range.
